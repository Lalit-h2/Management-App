            ...
            <div className="md:flex">
              <div className="md:w-1/2 p-8">
                ...
                <p className="text-zinc-300 mb-4">
                  Our school management system provides a comprehensive solution for educational institutions to
                  streamline administrative tasks, enhance communication between teachers, students, and parents, and
                  improve overall efficiency.
                </p>
                <p className="text-zinc-300 mb-4">
                  Founded in 2010, we have been serving educational institutions across the country with our innovative
                  technology solutions designed specifically for the education sector.
                </p>
                <p className="text-zinc-300">
                  Our team of dedicated professionals works tirelessly to ensure that our system meets the evolving
          ...
          <div className="flex py-8">
            <div className="bg-gradient-to-br from-indigo-900 to-indigo-700 rounded-lg shadow-xl p-8">
              ...
              <p className="text-indigo-100 mb-4">
                To revolutionize education management through technology, making it more accessible, efficient, and
                effective for all stakeholders.
              </p>
              <p className="text-indigo-100">
                We envision a future where educational institutions can focus more on teaching and learning, while
                administrative tasks are seamlessly handled by our intuitive system.
              </p>
            </div>
